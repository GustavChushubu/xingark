...
setInterval(function() { 
    ...
    //button = document.getElementsByClassName('I2QcFnn2MS')[0].children[0].children[0].children[0]
    //button.click()
}, 1000);
setInterval(function() {
    document.getElementsByClassName('jXWNQlkoCX tdfd9SqjbL lqV8w1HVl1 A84DZf7LIV')[0].click()
}, 200);
